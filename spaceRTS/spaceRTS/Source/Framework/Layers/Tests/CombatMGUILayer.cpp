#include "MEpch.h"
#include "CombatIMGUILayer.h"
#include "imgui\imgui.h"

namespace MYENGINE
{
    CombatIMGUILayer::CombatIMGUILayer() :ImGuiLayer("CombatIMGUILayer")
	{

	}
    CombatIMGUILayer::~CombatIMGUILayer()
	{

	}
	void CombatIMGUILayer::OnUpdateGUI(const float& deltaTime)
	{
		ImGui::Begin("Debug");
